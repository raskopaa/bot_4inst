...
async def send_sci_schedule(update, context):
    ...
    if department == "Прикладной искусственный интеллект: перспективы и риски":
        ...
        "▪️Разработка программного обеспечения.\n\n"
            ...
            "<b>Календарь:</b>\n"
            "1 декабря 2024 — Подготовка материалов\n"
            "9 декабря 2024 — Прием комплекта материалов\n"
            "4 апреля 2025 — Подготовка материалов программы\n"
            "7–18 апреля 2025 — Проведение конференции\n\n"
